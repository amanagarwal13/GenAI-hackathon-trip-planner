...
place_agent = Agent(
    ...
    name="place_agent",
    description="Recommends a travel destination based on user interest.",
...
poi_agent = Agent(
    model="gemini-2.5-pro",
    name="poi_agent",
    description="Recommends points of interest in a specific location.",
...
inspiration_agent = Agent(
    ...
    description="Helps users with travel inspirations and points of interest",
